...
Template.home.currentProfile = function(){
    return Meteor.users.findOne({ _id: { $ne: Meteor.userId() } }) || Meteor.user();
};
Template.home.wall = function(){
...
Template.home.events({
  'click .wall_records_header a': function(e){
      e.preventDefault();
      user = Template.home.currentProfile();
      if(Session.get('wall_sort')){
    ...
    'click .fa-chevron-up': function(e){
        ...
        $('.new_wall,.append_to_wall').addClass('hidden');
    ...
    'click .fa-chevron-down': function(e){
        ...
        $('.new_wall, .append_to_wall').removeClass('hidden');
    },
    ...
    'click .new_wall': function(){
        ...
        sender_id = Template.home.currentProfile()._id;
